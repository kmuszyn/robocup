 ...
 * for robocup.
 * Author: Kamil Muszynski, based on Holonome3Sw_Position2d.hh
 * Date:2-12-2009
 */

#ifndef HOLONOME3SWD_POSITION2D_HH
#define HOLONOME3SWD_POSITION2D_HH
...
/// \{
/** \defgroup holonome3swd_position2d holonome3swd_position2d

  \brief Position2D controller for an holonomous robot using 3 swedish
  wheels and dribbler bar for RoboCup purposes.
  ...
  \verbatim
  <controller:holonome3swd_position2d name="controller-name">
    <wheels>
    ...
    <dribbler>
		 <left-joint>left-joint-name</left-joint>
		 <right-joint>right-joint-name</right-joint>
		 <speed>speed-to-apply</speed>	//in radian per sec
...
class Holonome3SwD_Position2d : public Controller
{
  ...
  /// Destructor
  public: virtual ~Holonome3SwD_Position2d();
  ...
  // The dribbler joints.
  private: Joint *dribblerJoint[2];
  
  //kicker joint (slider)
  private: Joint *kickerJoint;
